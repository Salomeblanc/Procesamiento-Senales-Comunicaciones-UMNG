...
- **Osciloscopio:** adquisición y visualización de las señales.
- **MATLAB:** procesamiento de los datos, generación de gráficas y análisis mediante FFT.
- **CSV:** almacenamiento de los datos obtenidos durante las mediciones.
